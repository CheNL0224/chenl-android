...
public final class SimpleExoPlayerView extends FrameLayout {
    ...
    private void initView() {
        if (controller != null) {
            this.controller.setBackListener(new PlaybackControlView.BackListener() {
                @Override
                public void OnBack() {

                }
            });
            this.controller.setFullScreenChangeListener(new PlaybackControlView.FullScreenChangeListener() {
                @Override
                public void OnFullScreenChange(boolean isFullScreen) {
                    changeRequestedOrientation(isFullScreen);
                }
            });
        }
    }
    ...
    private void changeRequestedOrientation(boolean isChecked) {
...
//            setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_FIXED_HEIGHT);
            if (parentView != null) {
                tempView = parentView;
                tempLayoutParams = layoutParams;
                parentView.removeView(this);
            }
            contentView.addView(this, params);
            if (this.controller != null) {
                this.controller.getExoTitleBar().setVisibility(View.VISIBLE);
                this.controller.getPlayPreviousButton().setVisibility(View.VISIBLE);
                this.controller.getPlayNextButton().setVisibility(View.VISIBLE);
            }
        } else {
            if (!verticalScreen) {
                // 竖屏
...
//            setResizeMode(AspectRatioFrameLayout.RESIZE_MODE_FIXED_WIDTH);
            ...
            if (tempView != null) {
                tempView.addView(this, tempLayoutParams);
            }
            if (this.controller != null) {
                this.controller.getExoTitleBar().setVisibility(View.GONE);
                this.controller.getPlayPreviousButton().setVisibility(View.GONE);
                this.controller.getPlayNextButton().setVisibility(View.GONE);
            }
        }
    }
    ...
    public void setControlListener(ControlListener controlListener) {
        if (this.controller != null) {
            this.controller.setControlListener(controlListener);
        }
    }
    ...
    public void setTitle(@StringRes int resId) {
        if (this.controller != null) {
            this.controller.setTitle(resId);
        }
    }
    ...
    public boolean isFullscreen() {
        if (this.controller != null) {
            return controller.getExoFullscreen().isChecked();
        } else {
            return false;
        }
    }
    ...
    public void outFullscreen() {
        if (this.controller != null) {
            controller.getExoFullscreen().setChecked(false);
        }
    }
    ...
    private static void configureEditModeLogoV23(Resources resources, ImageView logo) {
        logo.setImageDrawable(resources.getDrawable(R.drawable.exo_controls_play, null));
        logo.setBackgroundColor(resources.getColor(R.color.exo_edit_mode_background_color, null));
    }

    @SuppressWarnings("deprecation")
    private static void configureEditModeLogo(Resources resources, ImageView logo) {
        logo.setImageDrawable(resources.getDrawable(R.drawable.exo_controls_play));
