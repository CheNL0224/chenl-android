...
public class IncResult {
    ...
    public List<IncVideo> getVideo() {
        return video;
    }

    public void setVideo(List<IncVideo> video) {
        this.video = video;
    }
}
