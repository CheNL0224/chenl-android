package com.social.chenl.common.config;

import com.social.chenl.BuildConfig;
...
public class Api {
     ...
     */
    private static String baseUrl = "http://47.100.245.128/chenl";
    public static String rssUrl = "http://47.100.245.128/rss/chenl";

    static {
        String flavor = BuildConfig.FLAVOR;
        switch (flavor) {
            case "alpha":
                baseUrl = "http://47.100.245.128/chenl-test";
                rssUrl = "http://47.100.245.128/rss/chenl-test";
                break;
            case "local":
                baseUrl = "http://192.168.21.103:8090/chenl";
                rssUrl = "http://192.168.21.103/rss/chenl-test";
                break;
            case "online":
                baseUrl = "http://47.100.245.128/chenl";
                rssUrl = "http://47.100.245.128/rss/chenl";
                break;
        }
    }
